            ...
            <div className="container-teste">
                <div className="teste-personalidade">
                    ...
                    <section className="test-slider">
                        ...
                        />
                        <DiscreteSlider
                            titulo="Eu me preocupo com as coisas."
                        />
                        <DiscreteSlider
                            titulo="Eu fico irritado facilmente."
                        />
                        <DiscreteSlider
                            titulo="Muitas vezes me sinto triste."
                        />
                        <DiscreteSlider
                            titulo="Eu gosto de receber ordens."
                        />
                        <DiscreteSlider
                            titulo="Eu sigo um cronograma."
                        />
                        <DiscreteSlider
                            titulo="Falo com muitas pessoas diferentes nas festas."
                        />
                        <DiscreteSlider
                            titulo="Eu fico estressado facilmente."
                        />
                        <DiscreteSlider
                            titulo="Passo um tempo refletindo sobre as coisas."
                        />
                        <DiscreteSlider
                            titulo="Eu não tenho uma boa imaginação."
                        />
                        <div id="butoes">
                            <Button
